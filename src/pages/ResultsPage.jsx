    ...
    <section className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="space-y-2">
          ...
          <h2 className="text-3xl font-semibold tracking-tight text-slate-900">Played Fixtures, Scores, and Confidence</h2>
          <p className="max-w-3xl text-sm text-muted-foreground md:text-base">
            Review completed fixtures for the selected season with model confidence, probabilities, and key match stats.
          </p>
        </div>
        ...
        <CardContent className="pt-6">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div className="space-y-0.5">
              <p className="text-sm text-slate-600">{matches.length} played fixtures</p>
              <p className="text-xs text-slate-500">Open any row for the side detail panel.</p>
            </div>
            <MatchColumnsMenu
